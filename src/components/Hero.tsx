...
const Hero = () => {
    ...
    return (
        ...
        <header className="px-[clamp(1rem,4vw,4rem)] min-h-screen bg-[url(../assets/background.jpg)] bg-cover relative after:absolute after:inset-0 after:bg-blue-950 after:opacity-95  after:content-[''] py-6">
            <NavBar />
